...
use pwc_node_runtime::{self, opaque::Block, GenesisConfig, RuntimeApi, WASM_BINARY};
use std::sync::Arc;
...
native_executor_instance!(
	pub Executor,
	pwc_node_runtime::api::dispatch,
	pwc_node_runtime::native_version
);
...
macro_rules! new_full_start {
    ($config:expr) => {{
        ...
        let builder = substrate_service::ServiceBuilder::new_full::<
            pwc_node_runtime::opaque::Block,
            pwc_node_runtime::RuntimeApi,
        ...
        .with_import_queue(|_config, client, mut select_chain, transaction_pool| {
            ...
            let (block_import, link_half) =
                grandpa::block_import::<_, _, _, pwc_node_runtime::RuntimeApi, _, _>(
                    client.clone(),
                    client.clone(),
                    select_chain,
                )?;
